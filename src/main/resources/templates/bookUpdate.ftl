...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		<h1 class="page-header">修改入库书籍</h1>
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title text-center">修改图书信息</h3>
					</div>
					<div class="panel-body">
						<form action="/updateBookInfo/${bookInfo.bookId}" method="post" >
							<table class="table table-bordered">
								<tr>
									<td>图书编号：</td>
									<td><input type="text" class="form-control" value="${bookInfo.bookCode}" name="bookCode"/></td>
									<td colspan="2"></td>
									<td>图书名称：</td>
									<td><input type="text" class="form-control" value="${bookInfo.bookName}" name="bookName"/></td>
								</tr>
								<tr>
									<td>图书类型：
									...
									<td colspan="2"></td>
									<td>作者：</td>
									<td><input type="text" class="form-control" value="${bookInfo.bookAuthor}" name="bookAuthor"/></td>
								</tr>
								<tr>
									<td>出版社：</td>
									<td><input type="text" class="form-control" value="${bookInfo.publishPress}" name="publishPress" /></td>
									<td colspan="2"></td>
									<td>是否借阅：</td>
								...
								<tr>
									<td>入库人：</td>
									<td><input type="text" class="form-control"  value="${bookInfo.createdBy}" name="createdBy" /></td>
									<td colspan="2"></td>
									<td>入库时间：</td>
									<td><input type="text" class="form-control"
										id="datetimepicker" value="${bookInfo.creationTime}" name="creationTime" /></td>
								</tr>
							</table>
